    ...
    <section id="experience" className="mb-16 scroll-mt-16 md:mb-24 lg:mb-36 lg:scroll-mt-24">
      ...
      <div>
        {experiences.map((exp, index) => (
          <div
            key={index}
            className="group relative rounded-lg border border-primary/30 bg-gradient-to-br from-primary/5 to-transparent p-6 transition-all hover:border-primary/50 hover:shadow-lg hover:shadow-primary/5"
          >
            {/* Current badge */}
            {exp.isCurrent && (
